...
class _SuccessTabState extends State<SuccessTab> {
  List<dynamic> succData = []; // สร้าง List สำหรับเก็บข้อมูลที่ดึงมา
  ...
  Future<void> fetchUserId(String email) async {
    final String url = "http://${Global.ip_8080}/gotwo/getUserId.php"; // URL API
    try {
